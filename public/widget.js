 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="ai-changelog" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "ai-changelog";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "ai-changelog") + "_chat_session";
