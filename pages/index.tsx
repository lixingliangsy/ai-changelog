  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://ai-changelog.lxsaihub.com/" />
        <script type="application/ld+json">{`{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "How is this different from dumping git log?", "acceptedAnswer": {"@type": "Answer", "text": "Keep a Changelog states changelogs are for humans and that commit-log diffs are noisy. AI Changelog curates notable changes across commits into grouped release notes."}}, {"@type": "Question", "name": "Does it follow Keep a Changelog?", "acceptedAnswer": {"@type": "Answer", "text": "Output is structured for humans (latest first, grouped change types, version labels). Official guide: keepachangelog.com/en/1.1.0/."}}, {"@type": "Question", "name": "What about Semantic Versioning?", "acceptedAnswer": {"@type": "Answer", "text": "You supply a version label; SemVer (semver.org) still decides major/minor/patch meaning. The tool drafts notes — it does not invent your public API contract."}}, {"@type": "Question", "name": "Can Conventional Commits help?", "acceptedAnswer": {"@type": "Answer", "text": "Conventional Commits / conventional-changelog can draft categories from commit types. Keep a Changelog still expects a human to choose what is notable."}}, {"@type": "Question", "name": "Is this a GitHub Releases replacement?", "acceptedAnswer": {"@type": "Answer", "text": "No. Hosted release notes are vendor-tied. Keep a Changelog recommends a portable file in the repo; this tool drafts that content for you to own."}}, {"@type": "Question", "name": "Does it guarantee correctness?", "acceptedAnswer": {"@type": "Answer", "text": "No. It is decision-support. You review before publish. See Security honesty note."}}]}`}</script>
      </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">AI Changelog - definition</h2>
