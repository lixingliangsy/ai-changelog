...
export const PIPELINE_ID = 'ai-changelog-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 \u00b7 Collect commits & version",
  process: "Step 2/3 \u00b7 Curate notable changes",
  output: "Step 3/3 \u00b7 Publish-ready changelog",
}
